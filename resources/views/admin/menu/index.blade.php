...
@section('content')
  ...
  <div class="d-flex justify-content-around ml-1 flex-wrap">
    @foreach ($restaurant->dishes as $dish)
          
        <div class="card my-4 my_shadow" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <p style="height: 30%" class="card-text my_overflow">{{$dish->ingredients}}</p>
